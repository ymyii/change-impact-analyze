...
当前稳定 release 为 Analyzer `2.0.0`、Dependency Evidence Plugin `3.0.0`；当前 Analyzer 开发构建为 `2.0.1-SNAPSHOT`。Root command 为 `dependency-analyzer`。
