...
/** RTA-specific invokedynamic execution Decorator. */
final class RtaInvokeDynamicTargetSelector implements MethodTargetSelector {
    ...
    /** RTA-local build metadata. */
    private final InvokeDynamicModelState state;

    RtaInvokeDynamicTargetSelector(
