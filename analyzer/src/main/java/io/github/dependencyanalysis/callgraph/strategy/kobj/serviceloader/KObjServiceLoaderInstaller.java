...
import io.github.dependencyanalysis.callgraph.protocol.serviceloader.ServiceLoaderContractResolution;
import io.github.dependencyanalysis.callgraph.protocol.serviceloader.ServiceLoaderContractResolver;
...
public final class KObjServiceLoaderInstaller {
    ...
    /**
     * Creates a k-object ServiceLoader installer.
     *
     * @param index common provider facts
     * @param hierarchy resolved class hierarchy
     */
    public KObjServiceLoaderInstaller(
    ...
    /** @param builder propagation builder to configure */
    ...
    /** @return stable fixed-point limitations */
