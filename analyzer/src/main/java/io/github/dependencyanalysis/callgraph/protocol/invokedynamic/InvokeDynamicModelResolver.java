...
import io.github.dependencyanalysis.callgraph.protocol.methodhandle.MethodHandleReferenceKind;
...
public final class InvokeDynamicModelResolver {
    ...
    /**
     * Resolves one dynamic callsite through the public model registry.
     *
     * @param caller reachable caller
     * @param site source callsite
     * @param registry bootstrap model registry
     * @return modeled target, evidence, and limitations
     */
    public static InvokeDynamicResolution resolve(
            final CGNode caller,
     ...
     */
    public static InvokeDynamicResolution inspectForCha(
            final CGNode caller,
            final CallSiteReference site) {
        final SSAInvokeDynamicInstruction instruction = instruction(
                caller, site);
