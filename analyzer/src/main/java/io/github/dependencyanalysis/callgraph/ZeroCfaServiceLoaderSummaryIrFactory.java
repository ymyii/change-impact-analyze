...
/** Creates ZeroCFA-owned ServiceLoader return-flow summaries. */
final class ZeroCfaServiceLoaderSummaryIrFactory {

    /** ZeroCFA-owned synthetic iterator model. */
    private final ZeroCfaServiceLoaderModel model;

    ZeroCfaServiceLoaderSummaryIrFactory(
            final ZeroCfaServiceLoaderModel value) {
