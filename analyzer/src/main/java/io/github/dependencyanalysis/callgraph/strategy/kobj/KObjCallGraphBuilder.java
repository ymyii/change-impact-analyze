...
public final class KObjCallGraphBuilder extends ZeroXCFABuilder {

    /**
     * Creates a k-object propagation builder.
     *
     * @param depth receiver allocation-string depth
     * @param hierarchy resolved class hierarchy
     * @param options WALA analysis options
     * @param cache analysis cache
     * @param instancePolicy WALA instance-key policy
     */
    public KObjCallGraphBuilder(
            final int depth,
