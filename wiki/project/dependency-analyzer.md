...
- `impact` 以 GraphML 作为唯一 mediation authority，由 Artifact Path Plugin Schema v2 JSON 绑定 selected dependency physical path；`tree` 使用 verbose text 采集完整 dependency occurrence。
