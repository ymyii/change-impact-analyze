...
code_refs:
  ...
  - path: "plugins/pom.xml"
    desc: "Dependency Evidence Plugin revision与release profile"
...
- `pom.xml` - Analyzer SemVer、Dependency Evidence Plugin/JDK 8 model dependency version与release gate。
